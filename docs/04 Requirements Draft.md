...
- [ ] **R3: Robust Search** As a user, I should be able to search for a class using various parameters
	- [ ] **R3-1** As a user, I should be able to search for a class using a course code.
	- [ ] **R3-2** As a user, I should be able to search for all classes whose name contains a key word or key words.
	...
	- [ ] **R3-7** As a user, I should be able to filter the course search results based on the start and end times of classes. 
- [ ] **R4: Calendar view/schedule overview** As a user, I should be able to navigate to a calendar which shows all of my currently scheduled classes. I should be able to click on these classes for more information.
	...
	- [ ] **R4-2** As a user, I should be able to view this calender in a weekly format that clearly displays when classes are back-to-back and when there are gaps in-between. 
